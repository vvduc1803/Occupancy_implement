...
def get_lidar(frame):
	# print(len(frame_utils.parse_range_image_and_camera_projection(frames[frame_index])))
	...
	intensity_top_lidar_r0 = get_intensity(range_images)

	return points, intensity_top_lidar_r0

def get_intensity(range_images, ri_index=0):
	...
	range_image = range_images[1][ri_index]
